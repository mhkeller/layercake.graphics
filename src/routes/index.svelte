...
<div class="main">
	...
	<div id="dek">
		...
		<p>Unlike other libraries, chart components <span class="strong">live inside your project</span>, so you have complete control for <span class="strong">customization</span>.</p>
