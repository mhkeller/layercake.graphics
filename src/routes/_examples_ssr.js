...
export default [
	...
	{ replPath: '1969b7c74b124445ad9d55ad28542cd6?version=3.17.3', title: 'WebGL Scatter (svg axes, quadtree hover)', slug: 'ScatterWebgl', component: ScatterWebGL },
	{ replPath: 'b103883600fe49c2afeffa6ec2ed5136?version=3.17.3', title: 'Map (svg)', slug: 'MapSvg', component: MapSvg },
	{ replPath: '14c49b034a1e49bbbcd32e0ba749378c?version=3.17.3', title: 'Multilayer map (canvas + svg)', slug: 'MapLayered', component: MapLayered },
	{ replPath: '3dcdfc8c7aab4ca5a82f912f377a25e2?version=3.17.3', title: 'Column annotated', slug: 'Column', component: Column },
	{ replPath: '9d7b933184db447c83cc315ad278dabd?version=3.17.3', title: 'Stacked column', slug: 'ColumnStacked', component: ColumnStacked },
	{ replPath: '3e18cab5e88a4b29a14a08fdccd418c2?version=3.17.3', title: 'Bar', slug: 'Bar', component: Bar },
	{ replPath: 'af5ce39a12d74ed7a484010a49f09eaa?version=3.17.3', title: 'Stacked bar', slug: 'BarStacked', component: BarStacked },
	{ replPath: 'ea09c9f533594b3ab9ebb509c9bfc03a?version=3.17.3', title: 'Multiline (html labels + quadtree tooltip)', slug: 'MultiLine', component: MultiLine },
	{ replPath: '1eb71294f7c147ce906aa2dfc6e2f64e?version=3.17.3', title: 'Stacked area', slug: 'AreaStacked', component: AreaStacked },
	{ replPath: '9862620a31cd4f9dac8191df953e4532?version=3.17.3', title: 'Scatter (html)', slug: 'Scatter', component: Scatter },
	{ replPath: 'f3f78a8b122b40dda9ac1e32dee0737f?version=3.17.3', title: 'Cleveland dot plot', slug: 'ClevelandDotPlot', component: ClevelandDotPlot },
	{ replPath: 'c1e6634def024499ad026ecab3c39499?version=3.17.3', title: 'Calendar (one cake per month)', slug: 'Calendar', component: Calendar },
	...
	// { replPath: 'f3d14380fd7949bbbc9c36077b6a7d84?version=3.24.0', title: 'Sankey', slug: 'Sankey', component: Sankey },
];
